...
<body class="landing-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-info fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="/login">Guest</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="wrapper">
        ...
        <div class="section text-center">
            <div class="container">
                <h2 class="title">Presiden dan Wakil Presiden Mahasiswa</h2>
                <div class="team">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="team-player">
                                <img src="../assets/img/foto/1.jpeg" alt="Calon nomor 1" class="img-fluid img-raised">
                                <h4 class="title">Faqih & Rahman</h4>
                                <p class="category text-primary">Paslon 1</p>
                        ...
                        <div class="col-md-4">
                            <div class="team-player">
                                <img src="../assets/img/foto/2.jpeg" alt="Calon nomor 2" class="img-fluid img-raised">
                                <h4 class="title">Alfiany & Rini</h4>
                                <p class="category text-primary">Paslon 2</p>
                                <p class="description">You can write here details about one of your team members. You can give more details about what they do. Feel free to add some
                                    <a href="#">links</a> for people to be able to follow them outside the site.</p>
                                <a href="#pablo" class="btn btn-primary btn-icon btn-round"><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="col-md-4">
                            <div class="team-player">
                                <img src="../assets/img/foto/3.jpeg" alt="Calon nomor 3" class="img-fluid img-raised">
                                <h4 class="title">Ryan & Alfi</h4>
                                <p class="category text-primary">Paslon 3</p>
                                <p class="description">You can write here details about one of your team members. You can give more details about what they do. Feel free to add some
                                    <a href="#">links</a> for people to be able to follow them outside the site.</p>
