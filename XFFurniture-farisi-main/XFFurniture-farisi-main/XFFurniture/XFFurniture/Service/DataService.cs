...
namespace XFFurniture.Service
{
    public class DataService
    {
        ...
        private string namaTabel = "product";
        ...
        public List<Product> GetAll()
        {
            ...
            { 
                // ambil koleksi 
                var col = db.GetCollection<Product>(namaTabel); 
        ...
        public string Update(Product product)
        {
            try
            {
                ...
                using (var db = new LiteDatabase(dbFilename))
                {
                    ...
                    bool ada = col.Update(product);
                    if (!ada)
                        return "E:Not found";
                    else
                        return "S:" + product.Id.ToString();
                }
            }
            catch (Exception ex)
            {
